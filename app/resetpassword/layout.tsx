...
// NOTE: Initially this page was under auth but due to backend limitation it is written here
export default function ResetPasswordLayout(props: AuthRouteProps) {
